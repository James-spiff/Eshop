...
//Get's the product id and displays the product details
function ProductScreen({ match, history }) { //history helps us to redirect to another page
    ...
    // the code below triggers whenever the component is loaded
    ...
    const addToCartHandler = () => {
        history.push(`/cart/${match.params.id}?qty=${qty}`) //redirects to the CartScreen page/component with the quantity selected
    }
